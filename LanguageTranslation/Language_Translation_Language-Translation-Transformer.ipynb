...
# print(token_transform[TGT_LANGUAGE].shape) # AttributeError: 'functools.partial' object has no attribute 'shape'
# print(token_transform[TGT_LANGUAGE].size())  # AttributeError: 'functools.partial' object has no attribute 'size'

print(token_transform[TGT_LANGUAGE]) # 이 방법으로는 토큰들이 프린트가 안됨.
...
##################
print(translate(transformer, "Ein Mann in einem überladenen Motorboot rudert, während sein weiblicher Passagier einen Ausdruck der Enttäuschung in ihrem Gesicht hat.”))
